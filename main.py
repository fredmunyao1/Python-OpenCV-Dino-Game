...
while True:
    ...
    if hands:
        ...
        if fingerUp==[0,0,0,0,0]:
            cv2.putText(frame, 'Finger Count: o', (20,460), cv2.FONT_HERSHEY_COMPLEX, 1, (255,255,255), 1, cv2.LINE_AA)
        ...
        if fingerUp==[0,1,0,0,0]:
            ...
            cv2.putText(frame, 'Not Jumping', (410,460), cv2.FONT_HERSHEY_COMPLEX, 1, (255,255,255), 1, cv2.LINE_AA)
        if fingerUp==[0,1,1,0,0]:
            cv2.putText(frame, 'Finger Count: 2', (20,460), cv2.FONT_HERSHEY_COMPLEX, 1, (255,255,255), 1, cv2.LINE_AA)
            cv2.putText(frame, 'NotJumping', (410,460), cv2.FONT_HERSHEY_COMPLEX, 1, (255,255,255), 1, cv2.LINE_AA)
